...
public class Layout : MonoBehaviour
{
    ...
    public void ReadLayout(string xmlText)
    {
        ...
        multipler.x = float.Parse(xml["multiplier"][0].att("x"), CultureInfo.InvariantCulture);
        multipler.y = float.Parse(xml["multiplier"][0].att("y"), CultureInfo.InvariantCulture);
        //Прочитать слоты
        SlotDef tSD;
